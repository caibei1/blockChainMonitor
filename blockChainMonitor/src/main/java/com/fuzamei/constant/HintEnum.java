...
public enum HintEnum {
	...
	//yhl添加
	   INSERT_SUCCESS(200,"管理员添加成功"),
		INSERT_FAIL(500,"管理员添加失败"),
		UPDATE_SUCCESS(200,"管理员修改成功"),
		UPDATE_FAIL(500,"管理员修改失败"),
		SENDEMAIL_SUCCESS(200,"邮件发送成功"),
		SENDEMAIL_FAIL(500,"邮件发送失败"),
		SENDTXT_SUCCESS(200,"短信发送成功"),
		SENDTXT_FAIL(500,"短信发送失败"),
		ADDPROJECT_SUCCESS(200,"添加项目成功"),
	    QUERYEXCEPTION_SUCCESS(200,"查询异常信息成功"),
	    QUERYEXCEPTION_FAIL(500,"查询异常信息出错"),
		ADDPROJECT_FAIL(500,"添加项目失败");
